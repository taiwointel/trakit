...
const FALLBACK_RULES = [
  { pattern: /stamp duty|emtl|electronic money transfer levy|ussd charge|service charge|bank charge|vat charge|sms alert|account maintenance|card maintenance|card issuance fee|card fee|annual fee|quarterly charge|commission on turnover|cot\b/i, category: "Charges", subcategory: "Bank charges" },
